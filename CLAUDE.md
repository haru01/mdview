...
- `svg.py`, `mermaid.py`, `diff.py`, `diffview.py`, `selection.py`, `search.py`, `command.py` are all pure / framework-free (`command.py:parse_command` maps `:` input → a canonical command name).
